...
create async thunk in redux tool-kit 
create API async methods and define actions
save the response in the slices stats
show your data in your UI
verify redux browser extensions
